...
Get help with **CEVphantan** — the fleet equipment management platform from Phan Tan.

## Overview

CEVphantan helps organizations track equipment, manage work orders, and coordinate maintenance teams. This document explains how to get support, where to report issues, and where to find answers.
...
- **Bugs**: [Open an issue](https://github.com/Columbia-Cloudworks-LLC/CEVphantanissues/new) with a clear summary, steps to reproduce, expected vs actual behavior, and your environment (browser/OS, CCEVphantanersion, role).
- **Feature requests**: Same link; describe the use case, proposed solution, and who it helps.
- **Questions**: Open an issue and add the `question` label, or use [GitHub Discussions](https://github.com/Columbia-Cloudworks-LLC/CEVphantandiscussions) if you prefer.
...
If you’re an **CEVphantancustomer** (e.g. production or pilot) and need direct support:
...
**CEVphantan** · [Phan Tan](https://phantan.com)
