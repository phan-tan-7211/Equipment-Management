...
This document is the canonical technical reference for CEVphantans work-order
lifecycle, role capabilities, and status-transition rules. It is not the
step-by-step walkthrough for end users — those live in the **CEVphantanHelp Center** at
**`https://CEVphantaninfo/support/`**. Signed-in users report issues at
**`https://CEVphantanapp/dashboard/support`**.

## Where to find user-facing walkthroughs

- **Help Center** — `https://CEVphantaninfo/support/` (primary source of truth for
...
Image upload is documented step-by-step in the [Help Center](https://CEVphantaninfo/support/technician-field-work/add-notes-and-photos)
...
point them to the [Help Center](https://CEVphantaninfo/support/) or the status
page (`status.CEVphantanapp`). Signed-in users can report issues at
`https://CEVphantanapp/dashboard/support`.
...
user-facing walkthroughs live in the [Help Center](https://CEVphantaninfo/support/).*
