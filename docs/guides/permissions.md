...
CEVphantanhas two role layers: organization roles (Owner, Admin, Member) and team roles (Manager, Technician, Requestor, Viewer). For who should hold each role, see [Teams & Roles](/support/teams-roles/) in the Help Center.
...
> Billing capabilities were removed from CEVphantanin Jan 2025; there is no
