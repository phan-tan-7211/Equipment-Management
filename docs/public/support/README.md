...
This directory is served under `/support/*` on the CEVphantanHelp Center (`CCEVphantannfo`).
...
3. Reference the returned public URLs in CEVphantaninfo markdown articles.
...
```
https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/desktop/01-fleet-map-source-filter.png
```
