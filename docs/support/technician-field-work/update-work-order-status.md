...
![Work order accepted and assigned to a technician](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/technician-field-work/desktop/04-status-accepted-assigned.png)

![Work order in In Progress status](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/technician-field-work/desktop/05-status-in-progress.png)

![Mobile work order summary](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/technician-field-work/mobile/02-mobile-work-order-summary.png)

![Mobile Change Status sheet](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/technician-field-work/mobile/03-mobile-status-sheet.png)
