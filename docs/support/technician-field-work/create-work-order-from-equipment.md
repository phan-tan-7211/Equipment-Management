...
![Create Work Order dialog with PM checklist selected](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/technician-field-work/desktop/02-create-work-order-dialog.png)
...
![New work order detail page in Submitted status](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/technician-field-work/desktop/03-work-order-created-submitted.png)

![Mobile work order summary after creating from equipment](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/technician-field-work/mobile/02-mobile-work-order-summary.png)
