---
title: "Role overview for CEVphantan
...
CEVphantanhas two role tiers. The **organization** tier decides who can manage your company account. The **team** tier decides who can act on the equipment inside that team.

![Organization member roles on the Members tab](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/start-here/desktop/07-organization-member-roles.png)

![Team role overview on the Teams page](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/start-here/desktop/08-teams-role-overview.png)

![Mobile organization roles list](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/start-here/mobile/05-mobile-organization-roles.png)
