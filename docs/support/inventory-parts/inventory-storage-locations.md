...
![Organization inventory default location](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/desktop/07-organization-inventory-default.png)
...
![Inventory item effective storage location](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/desktop/06-inventory-item-effective-location.png)
...
![Mobile inventory map and directions](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/mobile/04-inventory-item-map-directions.png)
