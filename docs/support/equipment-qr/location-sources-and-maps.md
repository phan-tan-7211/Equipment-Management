...
CEVphantanresolves an equipment pin from several sources. You can preview each source on the equipment detail map, Fleet Map, and work order detail pages without changing the underlying record until you save an override.
...
![Fleet Map location source filter](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/desktop/01-fleet-map-source-filter.png)
...
![Equipment detail location source dropdown](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/desktop/02-equipment-detail-location-source.png)
...
![Inline equipment address actions](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/desktop/03-equipment-inline-address-actions.png)
...
![Live location capture modal](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/desktop/04-live-location-modal.png)
...
![Team location fallback preview](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/desktop/05-equipment-team-location-fallback.png)
...
![Work order location map](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/desktop/09-work-order-location-map.png)
...
![Mobile equipment location source](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/mobile/01-equipment-detail-location-source.png)

![Mobile inline address actions](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/mobile/02-equipment-inline-address-actions.png)

## Desktop walkthrough video

https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/desktop/demo.mp4

## Mobile walkthrough video

https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/location-maps/mobile/demo.mp4
