...
![Equipment detail location source dropdown](https://wgynakhoppqkrutnslmv.supabase.co/storage/v1/object/public/docs-media/support/location-maps/desktop/02-equipment-detail-location-source.png)
...
![Inline equipment address actions](https://wgynakhoppqkrutnslmv.supabase.co/storage/v1/object/public/docs-media/support/location-maps/desktop/03-equipment-inline-address-actions.png)
...
![Live location capture modal](https://wgynakhoppqkrutnslmv.supabase.co/storage/v1/object/public/docs-media/support/location-maps/desktop/04-live-location-modal.png)
...
![Team location fallback preview](https://wgynakhoppqkrutnslmv.supabase.co/storage/v1/object/public/docs-media/support/location-maps/desktop/05-equipment-team-location-fallback.png)
...
![Mobile equipment location source](https://wgynakhoppqkrutnslmv.supabase.co/storage/v1/object/public/docs-media/support/location-maps/mobile/01-equipment-detail-location-source.png)

![Mobile inline address actions](https://wgynakhoppqkrutnslmv.supabase.co/storage/v1/object/public/docs-media/support/location-maps/mobile/02-equipment-inline-address-actions.png)
...
https://wgynakhoppqkrutnslmv.supabase.co/storage/v1/object/public/docs-media/support/location-maps/mobile/demo.mp4
