...
![Manage PM checklist dialog](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/work-order-pm/desktop/01-add-pm-dialog.png)
...
CEVphantancreates the PM checklist and sets the work order to PM-enabled.

![PM checklist section after attaching a template](https://supabase.CEVphantanapp/storage/v1/object/public/docs-media/support/work-order-pm/desktop/02-pm-checklist-after-add.png)
...
If the current checklist already has completed items or PM notes, CEVphantanwarns you before resetting the PM data. Only the PM checklist is replaced — work order photos and notes remain.
