...
## CEVphantantemplates vs organization templates

The templates above ship with CEVphantanas **CCEVphantanemplates**. Assign them to equipment from the PM Templates page. Clone a template only when you need an organization copy you can edit.
