# CEVphantandocumentation

This tree holds Technical and Guides content for the public docs site, plus Operations runbooks that stay in the repository (not published on `CEVphantaninfo`).
...
Published CEVphantandocumentation—including technician how-tos, reference guides,
permissions, and workflows from this `docs/` tree—is hosted at **`https://CEVphantaninfo`**
...
**Product shortcuts while using CEVphantan**

- **Help Center (guides):** `https://CEVphantaninfo/support/`
- **Support & tickets (signed in):** `https://CEVphantanapp/dashboard/support`
- **Public support contact page:** `https://CEVphantanapp/support`

Use **`https://CEVphantaninfo/support/`** as the canonical URL to share, bookmark, or index for documentation.
...
They are **not** published on **`https://CEVphantaninfo`** (see [Public vs internal content](#public-vs-internal-content)).
Browse them on GitHub or in your local checkout:

- **[CI/CD Pipeline](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/ci-cd-pipeline.md)** - Complete CI/CD pipeline documentation including GitHub Actions, Vercel, and Supabase integrations
- **[Deployment](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/deployment.md)** - Complete deployment guide including build, hosting, runners, and versioning
- **[Migrations](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/migrations.md)** - Database migration guide with critical rules
- **[Migration Rules Quick Reference](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/migration-rules-quick-reference.md)** - Quick reference for migration best practices
- **[Local Supabase Development](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/local-supabase-development.md)** - Complete guide for local Supabase setup, edge function development, and migration synchronization
- **[QuickBooks OAuth](./ops/quickbooks-oauth.md).** Intuit OAuth, vault secrets, and sandbox wiring. Unpublished on CEVphantaninfo.
- **[Disaster Recovery](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/disaster-recovery.md)** - Database backup and point-in-time recovery procedures
...
1. **READ FIRST**: [Migrations](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/migrations.md) - ⚠️ **CRITICAL** migration rules
2. Review [Deployment](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/deployment.md) - Multi-platform deployment
3. Understand [Architecture](./technical/architecture.md) - System design
4. Monitor [Workflows](./guides/workflows.md) - User processes

### For End Users

1. Start at **`https://CEVphantaninfo/support/`** for published guides and how-tos.
2. To report issues while signed in, use **`https://CEVphantanapp/dashboard/support`**.
...
1. **READ FIRST**: [Migrations](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/migrations.md) - ⚠️ **CRITICAL** migration rules
2. Study [CI/CD Pipeline](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/ci-cd-pipeline.md) - Complete pipeline documentation
3. Study [Deployment](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/deployment.md) - Complete deployment guide
4. Review [Disaster Recovery](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/disaster-recovery.md) - Backup and PITR procedures
5. Review [Architecture](./technical/architecture.md) - System architecture
6. Reference [Migration Rules Quick Reference](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/migration-rules-quick-reference.md) - Quick reference
...
- [Migrations](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/migrations.md) - Migration strategies
...
#### Deployment & DevOps
- [CI/CD Pipeline](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/ci-cd-pipeline.md) - GitHub Actions, Vercel, Supabase integrations
- [Deployment Guide](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/deployment.md) - Platform-specific deployment
- [Migrations](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/migrations.md) - Database migrations
- [Local Supabase Development](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/local-supabase-development.md) - Local development setup and edge function workflow
- [Disaster Recovery](https://github.com/Columbia-Cloudworks-LLC/CEVphantanblob/main/docs/ops/disaster-recovery.md) - Database backup and PITR restoration
...
|--------|----------|---------|
| **`https://CEVphantaninfo`** | Customers, technicians, partners, general public | Help Center (`/support/`), guides, how-tos, PM templates, and integrations **without** live infrastructure identifiers or privileged command sequences. |
...
| **`CEVphantanapp/dashboard/support`** | Signed-in users | Report issues and track tickets only; guides live on CCEVphantannfo. |
...
**Maintained by**: CEVphantan Development Team  
