...
const supportSidebarArticles: Record<string, { text: string; link: string }[]> =
  {
    "start-here": [
      { text: "Welcome to CEV.PhanTan", link: "/support/start-here/welcome-to-CEV.PhanTan" },
...
export default defineConfig({
  title: "CEV.PhanTan Docs",
  description:
    "User guides, workflows, and how-tos for CEV.PhanTan fleet equipment management — technicians, managers, admins, and equipment owners.",
  lang: "en-US",
  ...
  sitemap: {
    hostname: "https://CEV.PhanTan.info",
  },
  vite: {
    css: {
      postcss: {
  ...
  head: [
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "CEV.PhanTan,docs,help center,support,fleet management,work orders,QR codes,CMMS",
      },
    ],
  ],
  themeConfig: {
    logo: { src: "/eqr-logo/icon.svg", alt: "CEV.PhanTan" },
    // Primary wordmark; CSS appends a secondary " Docs" label.
    siteTitle: "CEV.PhanTan",
    ...
    footer: {
      message:
        "CEV.PhanTan Docs — product app at CEV.PhanTan.app · status at status.CEV.PhanTan.app",
