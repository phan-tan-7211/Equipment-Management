...
- Access to CEVphantan mobile app or web interface
...
1. **Scan the QR Code** on the equipment using the CEVphantan mobile app
...
Field walkthroughs live in the Help Center. Start with [Add notes and photos](/support/technician-field-work/add-notes-and-photos). Signed-in users can open tickets at [CEVphantanapp/dashboard/support](https://CCEVphantanpp/dashboard/support).
