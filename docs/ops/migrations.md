...
>
> This is now formalized in CEVphantan Constitution v1.2.0 under "Database Migration Integrity" section.

## Overview

CEVphantan uses Supabase for database management with a structured migration system. This guide covers migration best practices, naming conventions, and troubleshooting.
