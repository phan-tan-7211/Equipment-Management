...
Related issue: [#1141](https://github.com/Columbia-Cloudworks-LLC/CEVphantanissues/1141)
...
Open a Supabase support ticket with project ref `ymxkzronkhwxzcdcbnwq` asking Supabase to refresh the `template1` collation version from `153.120` to `153.121`, or to perform the platform-owned equivalent. Track that vendor-owned residual in [#1143](https://github.com/Columbia-Cloudworks-LLC/CEVphantanissues/1143).
