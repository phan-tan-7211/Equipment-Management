...
hero:
  ...
  tagline: Step-by-step guides for technicians, managers, admins, and equipment owners — the same product family as CEVphantanapp.
  image:
  ...
  actions:
    ...
    - theme: alt
      text: Open App
      link: https://CEVphantanapp

features:
  - title: Start Here
    details: New to CEVphantan Orientation, navigation, invitations, and role overview.
...
Signed-in users can **report issues and track tickets** on the CEVphantanapp support page:

**[CEVphantanapp/dashboard/support](https://CCEVphantanpp/dashboard/support)**

For service availability, check **[status.CEVphantanapp](https://status.CCEVphantanpp)**.
