...
export const CEVPhanTan_REPAIR_COMMITMENTS: readonly CEVPhanTanCommitment[] = [
  {
    id: 'export',
    title: 'Your records leave with you',
    body: 'Organization owners can export operational data. If you stop using CEV.PhanTan, we do not keep your history locked behind a login as leverage.',
  },
  {
    id: 'no-hostage',
  ...
  },
  {
    ...
    body: 'CEV.PhanTan is a records and work-order system. We do not pair replacement parts to our software, withhold diagnostics as a rent, or brick equipment from the cloud.',
  },
];
...
export const LANDSCAPE_CASES: readonly LandscapeCase[] = [
  ...
  },
  {
    ...
    harm: 'A â€œpurchasedâ€ shelf was not a copy the customer kept. It was a revocable grant.',
  ...
  },
  {
    ...
    period: '2020s',
    practice:
      'Some replacement parts must cryptographically pair with the phone. Independent shops and Oregonâ€™s 2024 electronics repair law treated serialization used to block repair as the problem to regulate.',
  ...
  },
  {
    ...
    period: '2010sâ€“',
    practice:
      'Smart Licensing expects gear to report in to Ciscoâ€™s license service. Hardware that already shipped still needs an ongoing relationship with the vendorâ€™s control plane.',
    harm: 'A paid switch is not fully usable without the vendorâ€™s license servers and entitlements.',
  ...
  },
  {
    ...
    period: '2010sâ€“',
    practice:
      'Independent farmers and shops have argued that dealer-only diagnostic software and firmware keep tractors they already bought from being repaired in the field. The FTCâ€™s 2021 Nixing the Fix report collected this pattern across industries. Later manufacturer memoranda were widely criticized as non-binding.',
