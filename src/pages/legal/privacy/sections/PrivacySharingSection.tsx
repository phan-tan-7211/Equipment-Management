              ...
              items={[
                {
                  ...
                  content:
                    'We share data with the third-party service providers described above, strictly for the purposes stated. Each provider processes data only as necessary to deliver their specific service to CEV.PhanTan.',
                },
                {
