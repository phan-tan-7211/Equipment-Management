...
export function PrivacyCookiesSection() {
  return (
    ...
    >
            <p>
              CEV.PhanTan uses minimal browser storage, exclusively for application functionality. We do
              not use any third-party tracking cookies, advertising pixels, or browser
              fingerprinting techniques.
            </p>

            <p>
              On your first visit, CEV.PhanTan shows a cookies and browser-storage notice with explicit
              Accept and Reject choices. Your choice is stored in localStorage under{' '}
              <code>CEV.PhanTan:cookie-consent</code> so the notice does not reappear on every page load
            ...
            <PolicyList
              items={[
                {
                  label: <code>CEV.PhanTan:cookie-consent</code>,
                  content: (
                    <>
                ...
                {
                  label: <code>CEVPhanTan_admin_grants_*</code>,
                  content: (
                    <>
            ...
            <p>
              ...
              optional UI preference keys CEV.PhanTan controls and stops writing them until you Accept;
            ...
            <p>
              ...
              tokens are used solely to authenticate your requests to CEV.PhanTan and are managed
