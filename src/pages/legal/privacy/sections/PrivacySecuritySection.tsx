              ...
              items={[
                {
                  ...
                  content:
                    'All data transmitted between your browser and CEV.PhanTan is encrypted using TLS (HTTPS). We enforce HTTP Strict Transport Security (HSTS) with a one-year max-age, including subdomains, with preload.',
                },
                {
                ...
                },
                {
                  ...
                  content: (
                    <>
                      ...
                      within CEV.PhanTan&apos;s own application pages (same origin). The camera is used for
                      ...
                      speech service &mdash; CEV.PhanTan never records or stores audio.
                    </>
                  ),
                },
                {
