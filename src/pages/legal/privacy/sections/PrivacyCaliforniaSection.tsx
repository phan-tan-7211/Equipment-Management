    ...
    <LegalPolicySection title="10A. Your California Privacy Rights (CCPA/CPRA)">
      ...
      <ul>
        ...
        <li>
          ...
          Workspace, directory user data (names, emails) may be synced into CEV.PhanTan.
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <Link to="/privacy-request" className="underline">
            CEV.PhanTan.app/privacy-request
          </Link>
        </li>
        <li>
          <strong>Email:</strong>{' '}
          <ExternalLink href="mailto:privacy@CEV.PhanTan.app" className="hover:text-foreground">
            privacy@CEV.PhanTan.app
          </ExternalLink>
        </li>
      </ul>
