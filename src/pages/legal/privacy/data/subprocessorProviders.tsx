...
export const subprocessorProviders: SubprocessorProvider[] = [
  {
    ...
    items: [
                ...
                {
                  label: 'Data stored in CEV.PhanTan via Supabase:',
                  content:
  ...
  },
  {
    ...
    items: [
                ...
                {
                  label: 'Data stored in CEV.PhanTan:',
                  content:
  ...
  },
  {
    ...
    items: [
                {
                  label: 'Purpose:',
                  content: 'Hosting and content delivery network (CDN) for the CEV.PhanTan frontend web application.',
                },
                {
                  label: 'Data sent to Vercel:',
                  content:
                    'Standard HTTP requests from your browser when you access CEV.PhanTan (URL, headers, IP address).',
                },
                {
                  label: 'Data received from Vercel:',
                  content: 'The application assets (HTML, CSS, JavaScript) that power the CEV.PhanTan interface.',
                },
                {
                  label: 'Data stored in CEV.PhanTan:',
  ...
  },
  {
    ...
    items: [
                ...
                },
                {
                  label: 'Data stored in CEV.PhanTan:',
                  content:
                    'Historical Stripe customer IDs and subscription IDs remain in organization records for accounting continuity. No payment card numbers or bank account details were ever stored in CEV.PhanTan — those were handled entirely by Stripe.',
                },
              ],
  },
  {
    ...
    items: [
                {
                  label: 'Purpose:',
                  content:
                    'Export work order invoices to QuickBooks and synchronize customer lists between CEV.PhanTan teams and QuickBooks customers.',
                },
                {
                  label: 'Activation:',
                  content:
    ...
    items: [
                {
                  label: 'Purpose:',
                  content:
                    'Synchronize your Google Workspace directory users with CEV.PhanTan memberships, export work order data to Google Sheets, and upload PDF reports to Google Drive.',
                },
                {
                  label: 'Activation:',
                  content:
    ...
    items: [
                {
                  label: 'Purpose:',
                  content:
                    'Delivering push notifications to your device when you are not actively using CEV.PhanTan (e.g., work order assignments, status changes).',
                },
                {
