...
export const individualDataCategories: PrivacyDataCategoryRow[] = [
  ...
  },
  {
    ...
    dataPoints: (
      <>
        Each time you scan an CEV.PhanTan code, we record the scan timestamp and your user identity.{' '}
        <strong>
  ...
  },
  {
    ...
    dataPoints:
      "During signup, hCaptcha generates a one-time verification token. This token is sent to hCaptcha's servers for verification and then discarded — it is never stored in CEV.PhanTan.",
  },
  {
