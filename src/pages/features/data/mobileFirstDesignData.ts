...
export const content: FeaturePageContent = {
  ...
  ctaTitle: 'Open CEV.PhanTan on a phone',
  ctaDescription:
    'Create a free account and run the next job from a phone.',
  ctaPrimaryText: 'Open CEV.PhanTan on a phone',
};
...
export const benefits: Benefit[] = [
  ...
  },
  {
    ...
    description:
      'Use CEV.PhanTan on any device. iOS, Android, or desktop. The same account and data everywhere. Technicians work on phones in the field. Admins manage from larger screens.',
