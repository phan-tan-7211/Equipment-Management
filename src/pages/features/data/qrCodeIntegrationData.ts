...
export const showcases: Screenshot[] = [
  {
    ...
    imageAlt: 'CEV.PhanTan Equipment QR Code modal showing scannable QR code with equipment URL and download options',
  ...
  },
  {
    ...
    imageAlt: 'CEV.PhanTan Equipment list showing QR code buttons on each equipment card with team assignments and last maintenance dates',
