...
export const benefits: Benefit[] = [
  {
    ...
    description:
      'Connect your Workspace domain and sync users from your Google directory. Pull in everyone who belongs to your organization so you can add them as CEV.PhanTan™ members with a few clicks.',
  ...
  },
  {
    ...
    description:
      'Members sign in with their Google account. Admin access is granted after they authenticate with a Workspace identity. No separate CEV.PhanTan™ passwords to manage. Just Google.',
...
export const steps: Step[] = [
  {
    ...
    description:
      'In Organization Settings → Integrations, connect your Google Workspace. Authorize CEV.PhanTan™ to access your organization\'s directory. Your domain is linked to your CEV.PhanTan™ org.',
  },
  {
    number: 2,
  ...
  },
  {
    ...
    description:
      'Invited users sign in with their Google account. Once authenticated, they\'re added to the organization and can access CEV.PhanTan™ based on their role. No manual invite emails required.',
  },
];
...
export const showcases: ImageScreenshot[] = [
  ...
  },
  {
    ...
    imageAlt: 'Team member list showing Google Workspace members imported into CEV.PhanTan with assigned roles',
