...
export const benefits: Benefit[] = [
  ...
  },
  {
    ...
    description:
      'Connect QuickBooks via OAuth in Organization Settings. Sign in with your Intuit account, authorize CEV.PhanTan™, and you\'re done. Tokens refresh automatically. Reconnect only if needed.',
...
export const showcases: ShowcaseItem[] = [
  {
    ...
    alt: 'Animated mobile demo showing a completed CEV.PhanTan work order being exported to QuickBooks Online as a draft invoice',
    title: 'Export a Work Order to QuickBooks on Mobile',
    description:
      'Watch a completed work order flow from CEV.PhanTan into a QuickBooks Online draft invoice in a few taps. Labor, parts, and customer mapping carry over so you can review and send the invoice from QuickBooks.',
  },
  {
    kind: 'image',
