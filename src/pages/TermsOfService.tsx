    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="space-y-8">
        ...
        <LegalPolicySection title="16) Contact.">
            <p>
              <strong>ZNT LLC</strong> • Email: <a href="mailto:phantan7211@gmail.com" className="underline">phantan7211@gmail.com</a> • Website: <a href="https://equipqr.app" target="_blank" rel="noopener noreferrer" className="underline" aria-label="equipqr.app (opens in new tab)">https://equipqr.app</a>
            </p></LegalPolicySection>
      </div>
    </div>
  );
