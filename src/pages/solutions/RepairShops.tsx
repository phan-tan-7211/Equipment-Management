          ...
          <div className="container px-4 mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Real results from shops already using CEV.PhanTan daily.
              </p>
            </div>
                  ...
                  >
                    <li className="list-none">
                      <div className="rounded-2xl border border-primary/20 bg-primary/10 p-4 text-left shadow-sm shadow-primary/10">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">Every technician on the team uses CEV.PhanTan daily.</p>
                      </div>
                    </li>
                    <li className="list-none">
                      <div className="rounded-2xl border border-primary/20 bg-primary/10 p-4 text-left shadow-sm shadow-primary/10">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">Work orders close faster after moving the process into CEV.PhanTan.</p>
                      </div>
                    </li>
                  </ul>
                </CardContent>
