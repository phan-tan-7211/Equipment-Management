  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <PageSEO
        ...
        description="Submit a data subject request to CEV.PhanTan. Access, delete, correct your personal data, or limit use of sensitive personal information under CCPA/CPRA."
