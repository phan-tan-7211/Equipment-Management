      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            CEV.PhanTan security controls and trust posture overview.
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="text-sm text-muted-foreground">
            To report security concerns, contact <a className="text-primary underline" href="mailto:security@CEV.PhanTan.app">security@CEV.PhanTan.app</a>.
          </CardContent>
        </Card>
      </div>
    </Page>
