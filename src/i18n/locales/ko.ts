const ko = {
  ...
  auth: {
    ...
    joinOrganization: '조직 참여',
    joinOrganizationHint: '{{name}}에 참여하려면 계정을 만드세요.',
    ...
    createAccountAndJoin: '계정 만들기 및 조직 참여',
    ...
    inviteOnlyBanner: '{{name}}의 초대를 받았습니다. 비밀번호를 만들어 이 조직에 참여하세요. 별도의 워크스페이스는 필요하지 않습니다.',
