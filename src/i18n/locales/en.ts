const en = {
  ...
  auth: {
    ...
    joinOrganization: 'Join your organization',
    joinOrganizationHint: 'Create your account to join {{name}}',
    ...
    createAccountAndJoin: 'Create Account & Join Organization',
    ...
    inviteOnlyBanner: 'You are invited to {{name}}. Create your password to join this organization; no separate workspace is needed.',
