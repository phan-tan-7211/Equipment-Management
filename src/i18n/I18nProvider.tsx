...
const resources = {
  ...
  vi: { ...vi, ...coreResources.vi, ...dashboardWidgetResources.vi, ...equipmentResources.vi, ...equipmentFormResources.vi, ...equipmentBulkResources.vi, ...equipmentAuxResources.vi, ...equipmentImportResources.vi, ...equipmentLocationResources.vi, ...equipmentCustomAttributeResources.vi, ...equipmentDeleteResources.vi, ...equipmentDetailsResources.vi, ...equipmentPMResources.vi, ...equipmentInsightsResources.vi, ...equipmentQRScanResources.vi, ...equipmentScanResources.vi, ...equipmentGroupResources.vi, ...equipmentMediaResources.vi, ...equipmentMutationResources.vi, ...equipmentScannerResources.vi, ...equipmentPartsResources.vi, ...equipmentInlineResources.vi, ...equipmentListResources.vi, ...equipmentMobileResources.vi, ...equipmentFinalizeResources.vi, ...equipmentResidualResources.vi, ...inventoryListResources.vi, ...inventoryDetailResources.vi, ...workOrderResources.vi, ...workOrderMobileResources.vi, ...pmTemplateResources.vi },
  en: { ...en, ...coreResources.en, ...dashboardWidgetResources.en, ...equipmentResources.en, ...equipmentFormResources.en, ...equipmentBulkResources.en, ...equipmentAuxResources.en, ...equipmentImportResources.en, ...equipmentLocationResources.en, ...equipmentCustomAttributeResources.en, ...equipmentDeleteResources.en, ...equipmentDetailsResources.en, ...equipmentPMResources.en, ...equipmentInsightsResources.en, ...equipmentQRScanResources.en, ...equipmentScanResources.en, ...equipmentGroupResources.en, ...equipmentMediaResources.en, ...equipmentMutationResources.en, ...equipmentScannerResources.en, ...equipmentPartsResources.en, ...equipmentInlineResources.en, ...equipmentListResources.en, ...equipmentMobileResources.en, ...equipmentFinalizeResources.en, ...equipmentResidualResources.en, ...inventoryListResources.en, ...inventoryDetailResources.en, ...workOrderResources.en, ...workOrderMobileResources.en, ...pmTemplateResources.en },
