...
const labels = {
  en: {
    ...
    pdfSubmitted: 'Submitted', pdfNote: 'Note', pdfRequiredAnswered: 'required answered', pdfPass: 'pass', pdfFail: 'fail', pdfDisclaimer: 'This report supports safety and audit documentation. It does not certify legal or regulatory compliance.', pdfFontLoadError: 'Could not load the PDF font. Please try again online.',
  },
  vi: {
    ...
    pdfSubmitted: 'Đã gửi', pdfNote: 'Ghi chú', pdfRequiredAnswered: 'mục bắt buộc đã trả lời', pdfPass: 'đạt', pdfFail: 'không đạt', pdfDisclaimer: 'Báo cáo này hỗ trợ ghi chép an toàn và kiểm toán; không xác nhận việc tuân thủ pháp luật hoặc quy định.', pdfFontLoadError: 'Không thể tải font PDF. Vui lòng thử lại khi có mạng.',
  },
  ko: {
    ...
    pdfSubmitted: '제출', pdfNote: '메모', pdfRequiredAnswered: '필수 항목 응답', pdfPass: '통과', pdfFail: '실패', pdfDisclaimer: '이 보고서는 안전 및 감사 기록을 위한 자료이며 법률이나 규정 준수를 인증하지 않습니다.', pdfFontLoadError: 'PDF 글꼴을 불러올 수 없습니다. 온라인 상태에서 다시 시도하세요.',
  },
} as const;
