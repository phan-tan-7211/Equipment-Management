...
export const FIELD_WORKSHEET_EXPORT_POLICY: WorkOrderExportPolicy = {
  ...
  description: 'Handwriting-friendly worksheet for technicians to complete PM checklists and log notes on paper. Results must be re-entered into CEV.PhanTan.',
  includeByDefault: [
    'work order summary and dates',
    'equipment details',
