  ...
  const handleSaveSelection = useCallback(
    async (selection: {
      ...
      toast({
        ...
        description: `CEV.PhanTan files for ${currentOrganization?.name ?? 'this organization'} will save to ${selection.displayName}.`,
      });
    },
      ...
      <IntegrationCardLayout>
        ...
        {!destination && !isLoadingDestination && (
          <p className="text-xs text-muted-foreground">
            Choose a Shared Drive folder or My Drive folder where CEV.PhanTan should store organization files.
          </p>
        )}
