    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This removes CEV.PhanTan&apos;s Google OAuth access, clears the cached Workspace directory,
            and releases your domain claim. Organization members and CEV.PhanTan data are kept. You can
