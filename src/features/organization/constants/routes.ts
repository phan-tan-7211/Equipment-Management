...
export const ORGANIZATION_EQUIPMENT_GROUPS_PATH = '/dashboard/organization/equipment-groups';
export const ORGANIZATION_AUDIT_LOG_PATH = '/dashboard/organization/audit-log';
