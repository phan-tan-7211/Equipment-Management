...
import CEVPhanTanIcon from '@/components/ui/CEVPhanTanIcon';
...
const PRODUCTION_URL = 'https://CEV.PhanTan.app';
      ...
      <main className="mx-auto flex min-h-screen w-full max-w-2xl flex-col px-4 py-5 sm:py-8">
        <div className="mb-5 flex items-center justify-between">
          <a
            ...
            aria-label="Open CEV.PhanTan production site"
          >
            <CEVPhanTanIcon className="h-9 w-9" title="" />
            <div>
              <p className="text-sm font-semibold">CEV.PhanTan</p>
        ...
        <footer className="mt-5 text-center text-[11px] leading-relaxed text-muted-foreground">
          <p>Â© {currentYear} Phan Tan. All rights reserved.</p>
          <p>CEVâ„¢ is a trademark of Phan Tan.</p>
        </footer>
      </main>
    </div>
  );
