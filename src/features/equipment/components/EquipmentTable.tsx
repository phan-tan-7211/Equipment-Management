...
type ColumnDragPreview = { label: string; x: number; y: number };
  ...
  >
    ...
    {columnDragPreview ? (
      <div
        ...
        data-equipment-column-drag-preview
        aria-hidden="true"
        style={{ left: columnDragPreview.x, top: columnDragPreview.y }}
      >
        {columnDragPreview.label}
      </div>
    ) : null}
    {imageHover ? (
      <div
