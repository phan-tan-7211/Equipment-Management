...
const STORAGE_PREFIX = 'CEV.PhanTan:equipment-table-columns:';
 ...
 *
 * Persists to `localStorage` under `CEV.PhanTan:equipment-table-columns:{orgId}`,
 * mirroring the `CEV.PhanTan:equipment-view-mode` precedent in `Equipment.tsx`.
