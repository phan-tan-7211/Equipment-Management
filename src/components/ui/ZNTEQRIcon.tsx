...
interface ZNTEQRIconProps extends React.SVGProps<SVGSVGElement> {
  /** Accessible label. Pass an empty string when decorative. */
  title?: string;
}

/** ZNTEQR brand icon — QR scanner mark in brand blue (#155EEF). */
const ZNTEQRIcon = React.forwardRef<SVGSVGElement, ZNTEQRIconProps>(
  ({ title = 'ZNTEQR', className, ...props }, ref) => {
    const reactId = React.useId();
    const titleId = title ? `znteqr-icon-title-${reactId}` : undefined;
    const fill = props.fill ?? '#155EEF';
    ...
    return (
      ...
      >
        ...
        <path d="M967.46,372.86v59.74c4.53,1,8.81,2.67,12.74,4.9v-51.9h69.76v69.76h-52.07 c2.18,3.93,3.8,8.21,4.76,12.74h60.04v-95.23H967.46z" />
...
ZNTEQRIcon.displayName = 'ZNTEQRIcon';
export default ZNTEQRIcon;
