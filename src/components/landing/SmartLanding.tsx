  ...
  return (
    <>
      <PageSEO
        ...
        description="Stop losing money to lost work orders. CEV.PhanTan gives heavy equipment repair shops secure QR code equipment tracking, team-based access, and one-click QuickBooks work order invoicing."
        path="/"
      />
      <Suspense
        fallback={
