...
const customerResults = [
  {
    ...
    description: 'Every technician on the team uses CEV.PhanTan daily.',
  },
  {
    value: '50%',
    label: 'Faster close times',
    description: 'Work orders close faster after moving the process into CEV.PhanTan.',
  },
];
      ...
      <div className="container px-4 mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="mx-auto max-w-2xl text-left text-xl text-muted-foreground sm:text-center">
            Currently deployed at equipment teams who rely on CEV™ for their daily operations.
          </p>
        </div>
