...
export const TeamRolesPermissionsSection = () => (
  <FeatureSection
    ...
    description="CEV.PhanTan uses a two-tier role system: organization-level roles that govern your whole account, and team-level roles that control access within each team."
  >
