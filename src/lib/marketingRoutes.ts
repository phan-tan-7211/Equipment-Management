...
export const MARKETING_ROUTES: readonly MarketingRoute[] = [
  {
    ...
    description:
      'Stop losing money to lost work orders. ZNTEQR gives heavy equipment repair shops secure QR code equipment tracking, team-based access, and one-click QuickBooks work order invoicing.',
  ...
  },
  {
    ...
    description:
      'Stop losing money to lost work orders. ZNTEQR gives heavy equipment repair shops secure QR code equipment tracking, team-based access, and one-click QuickBooks work order invoicing.',
    heading: 'ZNTEQR Marketing Home',
    navLabel: 'Landing',
    canonicalPath: '/',
    bodyParagraphs: [
      'This URL exists for backward compatibility. The canonical marketing home is the root path (/).',
      'ZNTEQR helps heavy equipment repair shops track equipment with QR codes, manage work orders, collaborate in teams, and export billing to QuickBooks Online.',
  ...
  }),
  {
    ...
    description:
      'Review the Terms of Service for ZNTEQR, the fleet equipment management platform by ZNT LLC. Covers accounts, billing, data, and liability.',
    heading: 'Terms of Service',
    bodyParagraphs: [
      'Review the Terms of Service for ZNTEQR, the fleet equipment management platform by ZNT LLC.',
  ...
  },
  {
    ...
    description:
      'What ZNTEQR collects, which processors handle it, how we protect it, and what rights you have.',
    heading: 'Privacy Policy',
    bodyParagraphs: [
      'ZNTEQR is committed to describing in plain language what we collect, why we collect it, and your privacy rights.',
  ...
  },
  {
    ...
    bodyParagraphs: [
      'ZNTEQR supports independent repair and will not hold your operational records hostage. This page is a public stance, not a contract.',
      'It explains common post-sale lock-in patterns in software, hardware, and physical repair, and states what ZNTEQR will and will not do with customer data and equipment control.',
    ],
  },
  {
    path: '/releases',
    ...
    description: 'Customer-facing changes in each published ZNTEQR release.',
    heading: 'Releases',
    navLabel: 'Releases',
    bodyParagraphs: [
      'Customer-facing changes in each published ZNTEQR release.',
