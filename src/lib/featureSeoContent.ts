...
export interface FeatureSeoEntry {
  path: string;
  /** Used by PageSEO (suffix "| CEV.PhanTan" added automatically except path "/" elsewhere). */
  pageTitle: string;
  description: string;
...
export const FEATURE_SEO_BY_PATH: Record<string, FeatureSeoEntry> = {
    ...
    faq: [
      {
        ...
        answer:
          'Technicians can use the CEV.PhanTan web app with any smartphone browser or use built-in camera flows depending on device settings. QR stickers encode HTTPS URLs so scans route straight into the signed-in workflow.',
      },
      {
        question: 'Can QR scanning connect customers to service requests?',
        answer:
          'CEV.PhanTan supports QR-powered workflows so stakeholders scanning equipment can land on role-appropriate experiences based on your org configuration and team assignments.',
      },
      {
        question: 'Is CEV.PhanTan free for heavy equipment repair shops?',
        answer:
          'CEV.PhanTan ships with a free tier designed for repair-shop workloads. Unlimited seats with sensible limits such as storage. Expand capacity when you outgrow starter quotas.',
      },
    ],
    howTo: {
      name: 'How QR code tracking works in CEV.PhanTan',
  ...
  '/features/quickbooks': {
    ...
    faq: [
      {
        question: 'Which QuickBooks product does CEV.PhanTan integrate with?',
        answer:
          'CEV.PhanTan integrates with QuickBooks Online via Intuit OAuth. Connection status appears inside Organization Settings so admins know tokens remain healthy.',
      },
      {
        question: 'What appears on customer-facing invoice exports?',
        answer:
          'Exports summarize labor and parts per CEV.PhanTan billing conventions. Operators finalize wording inside QuickBooks before sending invoices.',
      },
      {
        question: 'Can I reconnect QuickBooks if tokens expire?',
        answer:
          'Revisit Organization Settings, then Integrations, to reconnect. Mappings persist wherever CEV.PhanTan stores team-customer relationships.',
      },
    ],
    howTo: {
  ...
  '/features/inventory': {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'CEV.PhanTan highlights low-stock thresholds inside dashboards so purchasers can reorder before jobs stall.',
      },
      {
        question: 'Is barcode or QR supported for inventory?',
        answer:
          'CEV.PhanTan treats QR labels as first-class identifiers across equipment and inventory bins so scanning speeds receiving and issuing.',
      },
    ],
    howTo: {
    ...
    faq: [
      {
        ...
        answer:
          'CEV.PhanTan includes heavy-equipment-friendly templates such as forklifts, excavators, scissor lifts, skid steers, trailers, and compressors. Each is organized into inspection sections.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Operators attach photos per checklist policy using existing CEV.PhanTan media workflows tied to work orders.',
      },
    ],
    howTo: {
  ...
  '/features/google-workspace': {
    ...
    pageTitle: 'Google Workspace SSO & Directory Sync for CEV.PhanTan',
    description:
    ...
    heroTitle: 'Google Workspace SSO & Directory Sync for CEV.PhanTan',
    heroDescription:
      'Import users from your directory. Sign in with existing Google accounts.',
    faq: [
      {
        question: 'Does CEV.PhanTan replace Google MFA?',
        answer:
          'Google Authentication policies still apply. CEV.PhanTan inherits whatever MFA posture Workspace requires.',
      },
      {
        question: 'Can admins limit imported roles?',
        answer:
          'During import, admins map Workspace users to CEV.PhanTan organization roles before invitations activate.',
      },
      {
    ...
    howTo: {
      ...
      description: 'Google Workspace integration connects your directory to CEV.PhanTan™ in a few steps.',
    },
  },
  '/features/team-collaboration': {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'Sensitive actions remain attributable via CEV.PhanTan audit surfaces accessible to administrators.',
      },
    ],
    howTo: {
      name: 'How teams collaborate in CEV.PhanTan',
  ...
  '/features/fleet-visualization': {
    ...
    faq: [
      {
        question: 'Does CEV.PhanTan require GPS hardware?',
        answer:
  ...
  '/features/mobile-first-design': {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'CEV.PhanTan follows dark-theme contrast guidance with generous tap targets for gloved hands.',
      },
      {
    ...
    howTo: {
      ...
      description: 'CEV.PhanTan™ works in the shop, in the field, or at a desk.',
    },
  },
};
