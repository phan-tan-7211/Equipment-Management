...
export const DASHBOARD_CURRENT_ORG_STORAGE_KEY = 'CEVPhanTan_current_organization';

/**
 * Persist the active organization id for cross-document navigations (QR â†’
 * dashboard). Strictly necessary for correct org scoping â€” not preference-gated.
 */
