...
describe('sessionPersistence', () => {
  ...
  beforeEach(() => {
    ...
    // Preference writes require Accept â€” mirror vitest/setup-shared.ts default.
    mockLocalStorage['CEV.PhanTan:cookie-consent'] = 'accepted';
  ...
  describe('constants', () => {
    it('should return session storage key', () => {
      expect(getSessionStorageKey()).toBe('CEVPhanTan_session_data');
    });
