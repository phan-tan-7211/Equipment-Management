...
export const CSP_DIRECTIVES: readonly string[] = [
  ...
  "connect-src 'self' data: https://hcaptcha.com https://*.hcaptcha.com https://api.pwnedpasswords.com https://*.sentry.io https://*.supabase.co https://*.CEVphantan.app https://*.vercel.app https://maps.googleapis.com https://accounts.google.com https://*.googleapis.com https://*.gstatic.com wss://*.supabase.co wss://*.CEVphantan.app wss://*.vercel.app",
  "img-src 'self' data: blob: https: https://*.googleapis.com https://*.gstatic.com",
  "media-src 'self' blob: https://*.supabase.co https://*.CEVphantan.app",
