...
.DESCRIPTION
  Sources phantan7211@gmail.com (Google Business) credentials from the
  ZNT Agents vault. Use with browser MCP when blocked on admin.google.com
  ...
  phantan7211@gmail.com via dev/e2e/Load-GoogleLocalAuthEnv.ps1
