#!/usr/bin/env node
/**
 * Promote a READY Vercel deployment to production traffic (CEV.phantan.app).
 ...
 *   VERCEL_PROJECT_ID — default CEV.phantan project id
...
async function main() {
  ...
  process.stdout.write(
    '::notice::Vercel production promotion complete — CEV.phantan.app should now serve this build.\n',
  );
  process.exit(0);
}
