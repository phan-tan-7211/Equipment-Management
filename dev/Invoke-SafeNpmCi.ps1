...
. (Join-Path $PSScriptRoot 'Release-CEVphantanNodeModuleLocks.ps1')

Write-Host ''
Write-Host ' ============================================'
Write-Host '  CEVphantan - Safe npm ci (Windows lock recovery)'
Write-Host ' ============================================'
Write-Host ''
...
Invoke-CEVphantanSafeNpmCi @ciParams

if ($Docs) {
  Invoke-CEVphantanSafeNpmCi @ciParams -NpmPrefix 'docs' -SkipToolingStop
}
