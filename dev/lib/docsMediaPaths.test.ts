...
describe('buildDocsMediaPublicUrl', () => {
  it('builds anonymous public URLs for docs-media objects', () => {
    expect(
      buildDocsMediaPublicUrl(
        'https://supabase.CEVphantan.app',
        'support/location-maps/desktop/01-equipment-location-source.png',
      ),
    ).toBe(
      'https://supabase.CEVphantan.app/storage/v1/object/public/docs-media/support/location-maps/desktop/01-equipment-location-source.png',
    );
  });
});
...
describe('buildDocsMediaMarkdownImage', () => {
  it('emits markdown image syntax for docs articles', () => {
    expect(
      ...
      '![Equipment location source dropdown](https://supabase.CEVphantan.app/storage/v1/object/public/docs-media/support/location-maps/desktop/01-equipment-location-source.png)',
    );
  });
});
...
describe('buildDocsMediaMarkdownVideo', () => {
  it('emits a bare public URL line for inline video playback', () => {
    expect(
      buildDocsMediaMarkdownVideo({
        publicUrl:
          'https://supabase.CEVphantan.app/storage/v1/object/public/docs-media/support/location-maps/desktop/demo.mp4',
      }),
    ).toBe(
      'https://supabase.CEVphantan.app/storage/v1/object/public/docs-media/support/location-maps/desktop/demo.mp4',
    );
