...
<#
.SYNOPSIS
  Verify every MCP server CEV.phantan agents rely on is reachable and authenticated.
...
function Test-PluginFolder {
    ...
    $pluginRoot = 'C:\Users\viral\.cursor\projects\c-Users-viral-CEV.phantan\mcps'
...
Write-Host ""
Write-Host "CEV.phantan MCP Doctor - $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')"
Write-Host "================================================="
Write-Host ""
