 ...
 *
 * Safety: refuses parent/production project refs and supabase.CEV.phantan.app.
 *
...
export function assertBranchSafeTarget({ projectRef, apiUrl }) {
  ...
  if (host === 'supabase.CEV.phantan.app') {
    throw new Error('Refusing to seed production custom domain supabase.CEV.phantan.app');
  }
