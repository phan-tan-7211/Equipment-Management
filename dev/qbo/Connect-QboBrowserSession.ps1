...
.DESCRIPTION
  Loads the quickbooks-developer credentials from the CEV.phantan Agents 1Password vault
...
$env:QBO_USERNAME = (op read 'op://CEV.phantan Agents/quickbooks-developer/username').Trim()
$env:QBO_PASSWORD = (op read 'op://CEV.phantan Agents/quickbooks-developer/password').Trim()
