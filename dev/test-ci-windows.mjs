...
const WSL_SANDBOX = '~/.cache/CEV.phantan/test-ci';
...
SANDBOX="$WSL_HOME/.cache/CEV.phantan/test-ci"
EXPECTED_SANDBOX="$WSL_HOME/.cache/CEV.phantan/test-ci"
...
const scriptDir = fs.mkdtempSync(path.join(tmpRoot, 'CEV.phantan-test-ci-'));
