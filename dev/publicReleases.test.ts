...
- **Public releases page (#1460)** — Customers can review published CEV.PhanTan changes without opening GitHub.
...
- **CodeQL Action 4.37.3 (#1402)** — Bump the workflow action to keep Security Scan aligned.
    ...
    expect(releases[0].sections[0]?.entries[0]).toEqual({
      ...
      body: 'Customers can review published CEV.PhanTan changes without opening GitHub.',
      issueRefs: ['#1460'],
    });
