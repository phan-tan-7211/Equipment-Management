...
description: Postgres performance optimization and best practices from Supabase, adapted to CEVphantan's Supabase (Postgres + RLS) workflow. Use when editing SQL, migrations, indexes, or RLS policies.
license: MIT
metadata:
  author: supabase
  version: "1.0.0"
...
# Postgres Best Practices (Supabase, adapted for CEVphantan)

Comprehensive performance optimization guide for Postgres, maintained by Supabase. Contains rules across 8 categories, prioritized by impact to guide automated query optimization and schema design.

## CEVphantan applicability notes (important)

CEVphantan uses **Supabase Postgres**. When applying these rules in this repo:
