...
```typescript
import { test, expect } from '../user/fixtures/CEVphantantest';
...
Issue #1161 standardizes CEVphantaninfo walkthrough videos on desktop **and** mobile:
...
When updating CEVphantaninfo articles, also publish capture artifacts to the public **`docs-media`** bucket (stable paths for docs, not branch-scoped PR paths):
