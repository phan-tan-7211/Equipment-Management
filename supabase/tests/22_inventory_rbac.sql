...
INSERT INTO auth.users (
  ...
  ('22000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000000'::uuid, 'rbac-owner@cevphantan.test', extensions.crypt('password123', extensions.gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider":"email","providers":["email"]}'::jsonb, '{"name":"RBAC Owner"}'::jsonb, false, 'authenticated', 'authenticated', '', '', '', ''),
  ('22000000-0000-0000-0000-000000000002'::uuid, '00000000-0000-0000-0000-000000000000'::uuid, 'rbac-member@cevphantan.test', extensions.crypt('password123', extensions.gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider":"email","providers":["email"]}'::jsonb, '{"name":"RBAC Member"}'::jsonb, false, 'authenticated', 'authenticated', '', '', '', ''),
  ('22000000-0000-0000-0000-000000000003'::uuid, '00000000-0000-0000-0000-000000000000'::uuid, 'rbac-consumer@cevphantan.test', extensions.crypt('password123', extensions.gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider":"email","providers":["email"]}'::jsonb, '{"name":"RBAC Consumer"}'::jsonb, false, 'authenticated', 'authenticated', '', '', '', ''),
  ('22000000-0000-0000-0000-000000000004'::uuid, '00000000-0000-0000-0000-000000000000'::uuid, 'rbac-manager@cevphantan.test', extensions.crypt('password123', extensions.gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider":"email","providers":["email"]}'::jsonb, '{"name":"RBAC Manager"}'::jsonb, false, 'authenticated', 'authenticated', '', '', '', '')
