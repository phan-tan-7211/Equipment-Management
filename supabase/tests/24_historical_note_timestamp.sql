...
INSERT INTO auth.users (
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000000'::uuid,
    'note-ts-member@cevphantan.test',
...
VALUES
  ('14000000-0000-0000-0000-000000000001'::uuid, 'note-ts-admin@cevphantan.test', 'Note TS Admin'),
  ('14000000-0000-0000-0000-000000000002'::uuid, 'note-ts-member@cevphantan.test', 'Note TS Member')
ON CONFLICT (id) DO NOTHING;
