...
INSERT INTO auth.users (
  ...
  'pgtap-admin-pm@cevphantan.test',
...
INSERT INTO auth.users (
  ...
  '00000000-0000-0000-0000-000000000000'::uuid,
  'pgtap-member-pm@cevphantan.test',
  extensions.crypt('password123', extensions.gen_salt('bf')),
  NOW(),
  NOW(),
  NOW(),
...
INSERT INTO auth.users (
  ...
  '00000000-0000-0000-0000-000000000000'::uuid,
  'pgtap-outsider-pm@cevphantan.test',
  extensions.crypt('password123', extensions.gen_salt('bf')),
  NOW(),
  NOW(),
  NOW(),
...
VALUES
  ('11000000-0000-0000-0000-000000000001'::uuid, 'pgtap-admin-pm@cevphantan.test', 'pgTAP Admin PM'),
  ('11000000-0000-0000-0000-000000000002'::uuid, 'pgtap-member-pm@cevphantan.test', 'pgTAP Member PM'),
  ('11000000-0000-0000-0000-000000000003'::uuid, 'pgtap-outsider-pm@cevphantan.test', 'pgTAP Outsider PM')
ON CONFLICT (id) DO NOTHING;
