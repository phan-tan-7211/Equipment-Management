...
INSERT INTO auth.users (
  ...
  'pgtap-audit-admin@cevphantan.test',
...
INSERT INTO auth.users (
  ...
  '00000000-0000-0000-0000-000000000000'::uuid,
  'pgtap-audit-outsider@cevphantan.test',
  extensions.crypt('password123', extensions.gen_salt('bf')),
  NOW(),
  NOW(),
  NOW(),
...
INSERT INTO auth.users (
  ...
  '00000000-0000-0000-0000-000000000000'::uuid,
  'pgtap-audit-member@cevphantan.test',
  extensions.crypt('password123', extensions.gen_salt('bf')),
  NOW(),
  NOW(),
  NOW(),
...
VALUES
  ('11000000-0000-0000-0000-000000000001'::uuid, 'pgtap-audit-admin@cevphantan.test', 'pgTAP Audit Admin'),
  ('11000000-0000-0000-0000-000000000002'::uuid, 'pgtap-audit-outsider@cevphantan.test', 'pgTAP Audit Outsider'),
  ('11000000-0000-0000-0000-000000000003'::uuid, 'pgtap-audit-member@cevphantan.test', 'pgTAP Audit Member')
ON CONFLICT (id) DO NOTHING;
