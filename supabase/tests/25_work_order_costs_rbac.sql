...
INSERT INTO auth.users (
  ...
  ('25000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000000'::uuid, 'costs-owner@cevphantan.test', extensions.crypt('password123', extensions.gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider":"email","providers":["email"]}'::jsonb, '{"name":"Costs Owner"}'::jsonb, false, 'authenticated', 'authenticated', '', '', '', ''),
  ('25000000-0000-0000-0000-000000000002'::uuid, '00000000-0000-0000-0000-000000000000'::uuid, 'costs-tech@cevphantan.test', extensions.crypt('password123', extensions.gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider":"email","providers":["email"]}'::jsonb, '{"name":"Costs Tech"}'::jsonb, false, 'authenticated', 'authenticated', '', '', '', ''),
  ('25000000-0000-0000-0000-000000000003'::uuid, '00000000-0000-0000-0000-000000000000'::uuid, 'costs-requestor@cevphantan.test', extensions.crypt('password123', extensions.gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider":"email","providers":["email"]}'::jsonb, '{"name":"Costs Requestor"}'::jsonb, false, 'authenticated', 'authenticated', '', '', '', ''),
  ('25000000-0000-0000-0000-000000000004'::uuid, '00000000-0000-0000-0000-000000000000'::uuid, 'costs-viewer@cevphantan.test', extensions.crypt('password123', extensions.gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider":"email","providers":["email"]}'::jsonb, '{"name":"Costs Viewer"}'::jsonb, false, 'authenticated', 'authenticated', '', '', '', ''),
  ('25000000-0000-0000-0000-000000000005'::uuid, '00000000-0000-0000-0000-000000000000'::uuid, 'costs-plain@cevphantan.test', extensions.crypt('password123', extensions.gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider":"email","providers":["email"]}'::jsonb, '{"name":"Costs Plain"}'::jsonb, false, 'authenticated', 'authenticated', '', '', '', ''),
  ('25000000-0000-0000-0000-000000000006'::uuid, '00000000-0000-0000-0000-000000000000'::uuid, 'costs-assignee@cevphantan.test', extensions.crypt('password123', extensions.gen_salt('bf')), NOW(), NOW(), NOW(), '{"provider":"email","providers":["email"]}'::jsonb, '{"name":"Costs Assignee"}'::jsonb, false, 'authenticated', 'authenticated', '', '', '', '')
