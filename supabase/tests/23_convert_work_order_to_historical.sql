...
INSERT INTO auth.users (
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000000'::uuid,
    'convert-member@cevphantan.test',
...
VALUES
  ('13000000-0000-0000-0000-000000000001'::uuid, 'convert-admin@cevphantan.test', 'Convert Admin'),
  ('13000000-0000-0000-0000-000000000002'::uuid, 'convert-member@cevphantan.test', 'Convert Member')
ON CONFLICT (id) DO NOTHING;
