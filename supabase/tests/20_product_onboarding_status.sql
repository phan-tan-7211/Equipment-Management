...
INSERT INTO auth.users (
  ...
  (
    ...
    'pgtap-onboarding-owner@cevphantan.test',
  ...
  (
    ...
    '00000000-0000-0000-0000-000000000000'::uuid,
    'pgtap-onboarding-member@cevphantan.test',
    extensions.crypt('password123', extensions.gen_salt('bf')),
    NOW(),
    NOW(),
    NOW(),
...
VALUES
  ('12000000-0000-0000-0000-000000000001'::uuid, 'pgtap-onboarding-owner@cevphantan.test', 'pgTAP Onboarding Owner'),
  ('12000000-0000-0000-0000-000000000002'::uuid, 'pgtap-onboarding-member@cevphantan.test', 'pgTAP Onboarding Member')
ON CONFLICT (id) DO NOTHING;
