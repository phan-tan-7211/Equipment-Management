...
INSERT INTO auth.users (
  ...
  '00000000-0000-0000-0000-000000000000'::uuid,
  'pgtap-outsider@cevphantan.test',
  extensions.crypt('password123', extensions.gen_salt('bf')),
  NOW(),
  NOW(),
  NOW(),
...
VALUES
  ('10000000-0000-0000-0000-000000000001'::uuid, 'pgtap-admin@cevphantan.test', 'pgTAP Admin'),
  ('10000000-0000-0000-0000-000000000002'::uuid, 'pgtap-member@cevphantan.test', 'pgTAP Member'),
  ('10000000-0000-0000-0000-000000000003'::uuid, 'pgtap-outsider@cevphantan.test', 'pgTAP Outsider')
ON CONFLICT (id) DO NOTHING;
