-- ============================================================================
-- Migration: Ownership Transfer RPC Functions
-- 
-- Purpose: Implement functions for initiating, accepting, rejecting, and
-- cancelling ownership transfer requests.
-- ============================================================================

BEGIN;

-- ============================================================================
-- PART 1: Initiate Ownership Transfer
-- ============================================================================
...
COMMENT ON FUNCTION public.initiate_ownership_transfer(UUID, UUID, TEXT) IS 
  'Initiates an ownership transfer request. Only the current owner can call this.';

-- ============================================================================
-- PART 2: Respond to Ownership Transfer
-- ============================================================================
...
COMMENT ON FUNCTION public.respond_to_ownership_transfer(UUID, BOOLEAN, TEXT, TEXT) IS 
  'Accept or reject an ownership transfer request. Only the target user can call this.';

-- ============================================================================
-- PART 3: Cancel Ownership Transfer
-- ============================================================================
...
COMMENT ON FUNCTION public.cancel_ownership_transfer(UUID) IS 
  'Cancel a pending ownership transfer request. Only the initiator can call this.';

-- ============================================================================
-- PART 4: Get Pending Transfer Requests for User
-- ============================================================================

CREATE OR REPLACE FUNCTION public.get_pending_transfer_requests()
RETURNS TABLE (
  id UUID,
...
COMMENT ON FUNCTION public.get_pending_transfer_requests() IS 
