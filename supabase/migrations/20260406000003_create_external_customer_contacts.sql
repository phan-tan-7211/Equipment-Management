...
-- Stores contacts who are NOT registered cevphantan users (e.g. a client's site manager,
...
COMMENT ON TABLE public.external_customer_contacts IS
  'External contacts for a customer account — people who do not have cevphantan logins (site managers, billing contacts, dispatchers, etc.).';
