...
-- Description: Creates table to map cevphantan teams to QuickBooks customers for invoice export
-- Author: System
-- Date: 2025-12-02
...
COMMENT ON TABLE public.quickbooks_team_customers IS 
    'Maps cevphantan teams to QuickBooks Online customers. Used for invoice export to associate work orders with the correct QuickBooks customer.';
