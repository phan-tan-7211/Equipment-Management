-- Invited employees must not receive a personal organization before accepting their invitation.
-- The invitation acceptance RPC remains the source of truth for organization membership.
...
COMMENT ON FUNCTION public.handle_new_user() IS
  'Trigger for new user registration. Creates profile and personal org when allowed; invited signup users skip personal org creation until invitation acceptance.';
