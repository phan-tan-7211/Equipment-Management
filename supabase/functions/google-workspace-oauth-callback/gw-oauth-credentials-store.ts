...
export const DOMAIN_ALREADY_LINKED_ERROR =
  "This Google Workspace domain is already linked to another CEV.PhanTan organization.";
...
export async function storeGoogleWorkspaceCredentials(
  ...
  if (!refreshToken) {
    throw new Error(
      "Google Workspace refresh token missing. Revoke CEV.PhanTan at myaccount.google.com/permissions and reconnect.",
    );
  }
