...
export async function verifyGoogleWorkspaceAdmin(
  ...
  if (!isWorkspaceAdmin) {
    throw new Error(
      "Only Google Workspace administrators can connect their organization to CEV.PhanTan. " +
      "Please contact your Workspace admin to set up CEV.PhanTan for your organization."
    );
  }
}
