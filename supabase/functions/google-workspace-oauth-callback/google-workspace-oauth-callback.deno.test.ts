...
Deno.test({
  ...
  fn: () => {
    withEnv({ PUBLIC_SITE_URL: "https://CEV.PhanTan.app", PRODUCTION_URL: "https://CEV.PhanTan.app" }, () => {
      assertEquals(isValidRedirectUrl("/dashboard", "https://CEV.PhanTan.app"), true);
      assertEquals(isValidRedirectUrl("//evil.com/path", "https://CEV.PhanTan.app"), false);
    });
  },
});

Deno.test({
  name: "isValidRedirectUrl allows preview.CEV.PhanTan.app when PUBLIC_SITE_URL is production",
  permissions: { env: ["PUBLIC_SITE_URL", "PRODUCTION_URL"] },
  fn: () => {
    withEnv({ PUBLIC_SITE_URL: "https://CEV.PhanTan.app", PRODUCTION_URL: "https://CEV.PhanTan.app" }, () => {
      assertEquals(
        isValidRedirectUrl("https://preview.CEV.PhanTan.app/dashboard/organization/integrations", "https://CEV.PhanTan.app"),
        true,
      );
    });
  },
...
Deno.test({
  ...
  withEnv({ PUBLIC_SITE_URL: "https://CEV.PhanTan.app", PRODUCTION_URL: "https://CEV.PhanTan.app" }, () => {
    const url = buildSuccessRedirectUrl({
      originUrl: "https://preview.CEV.PhanTan.app",
      redirectUrl: "/dashboard/organization/integrations",
      resolvedProductionUrl: "https://CEV.PhanTan.app",
    });
    assertEquals(
      url,
      "https://preview.CEV.PhanTan.app/dashboard/organization/integrations?gw_connected=true",
    );
  });
});
...
Deno.test({
  ...
  withEnv({ PUBLIC_SITE_URL: "https://preview.CEV.PhanTan.app", PRODUCTION_URL: "https://CEV.PhanTan.app" }, () => {
    assertEquals(isValidRedirectUrl("http://localhost:8080/dashboard", "https://preview.CEV.PhanTan.app"), false);
    assertEquals(isValidRedirectUrl("http://127.0.0.1:8080/dashboard", "https://preview.CEV.PhanTan.app"), false);
    assertEquals(isValidRedirectUrl("https://equip-qr-evil.vercel.app/dashboard", "https://preview.CEV.PhanTan.app"), false);
  });
});
...
Deno.test({
  ...
  withEnv({ PUBLIC_SITE_URL: "http://localhost:8080", PRODUCTION_URL: "https://CEV.PhanTan.app" }, () => {
    assertEquals(isValidRedirectUrl("http://localhost:8080/dashboard", "https://CEV.PhanTan.app"), true);
    assertEquals(isValidRedirectUrl("http://127.0.0.1:8080/dashboard", "https://CEV.PhanTan.app"), true);
  });
});

Deno.test({
  name: "isTrustedDomain allows CEV.PhanTan.app subdomains",
  permissions: { env: ["PUBLIC_SITE_URL", "PRODUCTION_URL"] },
}, () => {
  withEnv({ PUBLIC_SITE_URL: "https://CEV.PhanTan.app", PRODUCTION_URL: "https://CEV.PhanTan.app" }, () => {
    assertEquals(isTrustedDomain("https://preview.CEV.PhanTan.app/dashboard"), true);
...
Deno.test({
  ...
  withEnv({ PUBLIC_SITE_URL: "https://CEV.PhanTan.app", PRODUCTION_URL: "https://CEV.PhanTan.app" }, () => {
    ...
    assertEquals(url, "https://CEV.PhanTan.app/dashboard/onboarding/workspace?gw_connected=true");
  });
});
...
Deno.test({
  ...
  withEnv({ PUBLIC_SITE_URL: "https://preview.CEV.PhanTan.app", PRODUCTION_URL: "https://CEV.PhanTan.app" }, () => {
    const url = buildGoogleOAuthErrorRedirectUrl({
      originUrl: "https://preview.CEV.PhanTan.app",
      redirectUrl: "/dashboard/organization/integrations",
      resolvedProductionUrl: "https://preview.CEV.PhanTan.app",
      errorCode: "oauth_failed",
      supportRef: "corr-abc123",
    });
    assertEquals(
      url,
      "https://preview.CEV.PhanTan.app/dashboard/organization/integrations?gw_error=oauth_failed&gw_ref=corr-abc123",
    );
  });
});
...
Deno.test({
  ...
  fn: () => {
    ...
    try {
      ...
      assertEquals(resolveFallbackProductionUrl(), "https://CEV.PhanTan.app");
    } finally {
      if (prev === undefined) {
...
Deno.test({
  ...
  fn: () => {
    ...
    try {
      Deno.env.set("PUBLIC_SITE_URL", "https://preview.CEV.PhanTan.app");
      Deno.env.set("PRODUCTION_URL", "https://CEV.PhanTan.app");
...
Deno.test({
  ...
  fn: () => {
    ...
    try {
      ...
      Deno.env.set("PRODUCTION_URL", "https://preview.CEV.PhanTan.app");
      assertEquals(isProductionEnvironment(), true);
      assertEquals(isPreviewEnvironment(), true);
...
Deno.test("resolveGoogleWorkspaceOAuthErrorCode maps internal messages to safe codes", () => {
  ...
  assertEquals(
    resolveGoogleWorkspaceOAuthErrorCode(
      new Error("Only Google Workspace administrators can connect their organization to CEV.PhanTan."),
    ),
    "not_workspace_admin",
  );
  assertEquals(
    resolveGoogleWorkspaceOAuthErrorCode(
      new Error("This Google Workspace domain is already linked to another CEV.PhanTan organization."),
    ),
