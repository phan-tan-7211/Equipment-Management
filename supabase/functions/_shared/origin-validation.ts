 ...
 *
 * We anchor to the CEV.PhanTan Vercel project slug (`CEV.PhanTan`; legacy `equip-qr` still
...
function getVercelPreviewPatterns(): RegExp[] {
  ...
  const slugs = override ? [override] : ["CEV.PhanTan", "equip-qr"];
...
export const PRODUCTION_ORIGIN = "https://CEV.PhanTan.app";
