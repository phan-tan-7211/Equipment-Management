 ...
 * 4. Creates a GitHub Issue in Columbia-Cloudworks-LLC/CEV.PhanTan
...
const GITHUB_REPO_NAME = "CEV.PhanTan";
...
---
*This issue was automatically created via the CEV.PhanTan in-app bug reporting system.*`;
}
...
async function createGitHubIssue(
  ...
  const response = await fetch(url, {
    ...
    headers: {
      ...
      "User-Agent": "CEV.PhanTan-BugReporter",
    },
    body: JSON.stringify({
      title,
      body,
