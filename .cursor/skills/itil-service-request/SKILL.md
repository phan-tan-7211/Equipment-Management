...
description: Lightweight feasibility and scope workflow for one CEVphantan feature, enhancement, integration, or vendor-cost request. Use when the user asks whether to build something, what it would cost in dollars, or how to scope a non-bug issue before implementation.
---
...
- Prefer existing CEVphantan patterns and vendors over adding a new service.
